...
const Home = () => {
  const CustomPrevArrow = ({ onClick }) => (
    <button
      className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-gray-800 text-white p-2 rounded-full shadow-md hover:bg-gray-700 transition"
      onClick={onClick}
    >
      <LeftOutlined />
    </button>
  ...
  const CustomNextArrow = ({ onClick }) => (
    <button
      className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-gray-800 text-white p-2 rounded-full shadow-md hover:bg-gray-700 transition"
      onClick={onClick}
    >
      <RightOutlined />
    </button>
